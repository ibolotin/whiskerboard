    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField()),
                ('description', models.CharField(max_length=255)),
                ('category', models.ForeignKey(related_name='services', to='board.Category', null=True)),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField()),
                ('description', models.CharField(max_length=255)),
                ('severity', models.IntegerField(choices=[(10, b'NORMAL'), (30, b'WARNING'), (40, b'ERROR'), (50, b'CRITICAL')])),
